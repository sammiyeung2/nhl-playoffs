...
public class TestPlayoffs {
	...
	public static void main(String[] args) {
		...
		st = pl.getStandings();
		System.out.println(st[2].getTeamA());
		System.out.println(st[2].getTeamB());
		System.out.println(st[2].getTeamAWins());
		System.out.println(st[2].getTeamBWins());
		...
		System.out.println(st[6].getTeamA());
		System.out.println(st[6].getTeamB());
		System.out.println(st[6].getTeamAWins());
		System.out.println(st[6].getTeamBWins());
